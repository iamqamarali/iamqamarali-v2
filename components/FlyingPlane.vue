...
<template>
    <div class="flying-plane-wrapper">
...
.scene {
    ...
    transform: translate3d(-50%, -50%, 100px) rotateX(-24deg) rotateY(44deg) rotateX(calc(var(--rotate-x, 0) * 1deg)) rotateY(calc(var(--rotate-y, 0) * 1deg));
}
.plane {
